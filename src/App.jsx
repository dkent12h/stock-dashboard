...
const PORTFOLIO_LIST = [
  ...
  // 국내 순환매 (이미지 기반 수정)
  { category: 'KR_CYCLE', name: 'Kodex AI전력핵심설비', symbol: '487240.KS', budget: '800만', buy: '20일선 상향 돌파 시', sell: '20일선 하향 이탈 시 익절' },
  { category: 'KR_CYCLE', name: 'Kodex 2차전지산업', symbol: '305720.KS', budget: '800만', buy: '20일선 상향 돌파 시', sell: '20일선 하향 이탈 시 익절' },
